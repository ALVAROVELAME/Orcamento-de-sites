        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 flex flex-col justify-between bg-slate-50 p-5 rounded-2xl border border-slate-100">
            <div className="space-y-5">
              <div className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold tracking-wider uppercase border ${colors[accentColor].bg} ${colors[accentColor].border} ${colors[accentColor].text}`}>
              ...
              <div>
                ...
                <p className="text-sm text-slate-700 font-medium leading-relaxed mt-1.5">
              ...
              <div className="space-y-3 pt-3 border-t border-slate-200/60">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 font-medium">Terça a Domingo: 12h às 23h</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-slate-900">Contato</h3>
                    <p className="text-sm text-slate-700 font-medium">(11) 99999-8888</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-sm font-bold text-slate-900">Endereço</h3>
                    <p className="text-sm text-slate-700 font-medium">Av. Paulista, 1000</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="sm:col-span-2 flex flex-col gap-1">
              <label htmlFor="name" className="text-sm font-bold text-slate-800 tracking-wide">Nome Completo</label>
              <input 
                id="name"
                type="text" 
                required
                placeholder="Ex: Álvaro Velame"
                className={`w-full bg-slate-50/50 border border-slate-200 rounded-xl px-3.5 py-3 text-sm font-medium text-slate-900 placeholder-slate-500 focus:outline-hidden focus:bg-white focus:ring-3 shadow-3xs transition-all duration-200 ${colors[accentColor].focus}`}
              />
            </div>

            <div className="flex flex-col gap-1">
              <label htmlFor="phone" className="text-sm font-bold text-slate-800 tracking-wide">WhatsApp</label>
              <input 
                id="phone"
                type="tel" 
                required
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="guests" className="text-sm font-bold text-slate-800 tracking-wide">Pessoas</label>
              <div className="relative">
                <Users className="w-4 h-4 text-slate-500 absolute left-3.5 top-1/2 -translate-y-1/2 pointer-events-none" />
                <select 
                  id="guests"
                  defaultValue="2"
                  className={`w-full bg-slate-50/50 border border-slate-200 rounded-xl pl-10 pr-3.5 py-3 text-sm font-semibold text-slate-900 focus:outline-hidden focus:bg-white focus:ring-3 shadow-3xs appearance-none cursor-pointer transition-all duration-200 ${colors[accentColor].focus}`}
                >
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="date" className="text-sm font-bold text-slate-800 tracking-wide">Data</label>
              <div className="relative">
                ...
                <input 
                  ...
                  type="date" 
                  required
                  className={`w-full bg-slate-50/50 border border-slate-200 rounded-xl pl-10 pr-3.5 py-3 text-sm font-semibold text-slate-900 focus:outline-hidden focus:bg-white focus:ring-3 shadow-3xs cursor-pointer transition-all duration-200 ${colors[accentColor].focus}`}
                />
              </div>
            </div>

            <div className="flex flex-col gap-1">
              <label htmlFor="time" className="text-sm font-bold text-slate-800 tracking-wide">Horário</label>
              <div className="relative">
            ...
            <div className="sm:col-span-2 mt-2">
              <button
                type="submit"
                disabled={loading}
                className={`w-full bg-gradient-to-r text-white font-bold text-sm py-3.5 px-4 rounded-xl shadow-md hover:shadow-lg active:scale-[0.99] transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-70 ${colors[accentColor].btn}`}
              >
